...
```bash
git clone https://github.com/sreevarshinidesa/color-blindness-simulator.git
```
...
4. Upload an image and explore the different simulation modes.
...
<img width="1882" height="907" alt="image" src="https://github.com/user-attachments/assets/2f405627-a180-4c81-8a91-43e30bc3adda" />
...
- Additional accessibility simulations
